...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "БПС-21М3"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\bps21m3.exe"
...
OutFile "bps21m3-setup.exe"
InstallDir "$PROGRAMFILES\БПС-21М3"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\БПС-21М3.lnk" "$INSTDIR\bps21m3.exe"
  CreateShortCut "$DESKTOP\БПС-21М3.lnk" "$INSTDIR\bps21m3.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\bps21m3.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\bps21m3.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\БПС-21М3.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\БПС-21М3.lnk"
