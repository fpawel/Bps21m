...
namespace MyWinForms
{
        ...
        public GridViewCheckBoxColumn()
        {
            DatagridViewCheckBoxHeaderCell datagridViewCheckBoxHeaderCell = 
                    new DatagridViewCheckBoxHeaderCell(
                        new CheckBoxClickedHandler(datagridViewCheckBoxHeaderCell_OnCheckBoxClicked)
                        );
    ...
    public class DatagridViewCheckBoxHeaderCell : DataGridViewColumnHeaderCell
    {
        ...
        public event CheckBoxClickedHandler BeforCheckBoxChanged;
        public event CheckBoxClickedHandler AfterCheckBoxChanged;

        readonly CheckBoxClickedHandler handleOnClick;
        public DatagridViewCheckBoxHeaderCell(CheckBoxClickedHandler handleOnClick_)
        {
            handleOnClick = handleOnClick_;
        }
        ...
        protected override void OnMouseClick(DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                if (BeforCheckBoxChanged != null)
                {
                    BeforCheckBoxChanged(e.ColumnIndex, _checked);
                    //this.DataGridView.InvalidateCell(this);
                }
                _checked = !_checked;
                handleOnClick(e.ColumnIndex, _checked);
                if (AfterCheckBoxChanged != null)
                {
                    AfterCheckBoxChanged(e.ColumnIndex, _checked);
                    this.DataGridView.InvalidateCell(this);
                }
            }
            base.OnMouseClick(e);
